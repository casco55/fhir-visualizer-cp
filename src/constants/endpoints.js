export const baseUrl = "https://ips-challenge.it.hs-heilbronn.de/fhir";
export const patientPath = "/Patient?identifier=";
export const conditionPath = "/Condition?subject=";
